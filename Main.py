...
if __name__ == "__main__":
    arguments_names_list = ["help", "Data_Processing=", "VL_Processing=", "topology_type=", "Routes_Optimization=", "task=", "net_type=", "Routes_Path_Processing="]
    arguments_list = ["--help", "--Data_Processing", "--VL_Processing", "--topology_type", "--Routes_Optimization", "--task", "--net_type", "--Routes_Path_Processing"]
    arguments_values_list = [[], ["True", "False"], ["True", "False"], ["ARINC664", "AFDX"], ["True", "False"], ["usage", "usage_and_loading"], ["A", "B"], ["True", "False"]]
    opts, args = getopt.getopt(sys.argv[1:], "-h", arguments_names_list)
    # 四大功能模块，执行标志默认为：0，即默认：不执行
    Data_Processing, VL_Processing, Routes_Optimization, Routes_Path_Processing = "False", "False", "False", "False"
