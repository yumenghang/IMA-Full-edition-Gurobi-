...
## 1.1  使用
__python Main.py -h --help --Data_Processing= --VL_Processing= --Round_BAG_of_Virtual_Links= --topology_type= --Routes_Optimization= --task= --net_type= --Routes_Path_Processing= --Verify_Transmitting_Path= --Verify_Bandwidth_Usage= --Generate_XML_File= --Comparison=\__
-h: 打印help信息；\
--help: 打印help信息；\
